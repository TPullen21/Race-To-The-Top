...
- (void)viewDidLoad
{
    ...
    UIPanGestureRecognizer *panRecogniser = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(panDetected:)];
    [self.pathView addGestureRecognizer:panRecogniser];
...
- (void)panDetected:(UIPanGestureRecognizer *)panRecognizer
{
    ...
    if (panRecognizer.state == UIGestureRecognizerStateBegan && fingerLocation.y > 650) {
